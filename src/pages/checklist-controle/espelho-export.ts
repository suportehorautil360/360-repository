/**
 * Lógica pura de exportação do espelho de ponto por período (intervalo de
 * datas). Reaproveita os cálculos de horas (horasPonto). Sem React/DOM.
 */
 ...
 * intervalo, incluindo dias que só têm abono. Ordenado por data.
 */
