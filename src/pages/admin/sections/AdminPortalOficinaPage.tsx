...
export function AdminPortalOficinaPage() {
  ...
  return (
    <section className="aba-conteudo ativa">
      <h2>Portal Oficina — selecione o município</h2>
      <p className="topbar-user" style={{ marginBottom: 20, maxWidth: 720 }}>
        Escolha o município cujo portal de oficina você deseja acessar como
        administrador.
      </p>
