...
import {
  ...
  fmtDataHora,
  OrigemBadge,
  SUPORTE_ORIGEM_CONFIG,
} from "./suporte/suporte-admin-shared";
...
export function SuporteOficinasAdminSection({
  ...
  return (
    <section className={cn("flex flex-col gap-5", !embedded && "pb-10")}>
      {!embedded ? (
        <header className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <OrigemBadge origem={ORIGEM} size="md" />
            </div>
          ...
          <Button
            ...
            onClick={() => void carregarInbox()}
            disabled={carregando}
          >
            <RefreshCw
              className={cn("mr-2 size-4", carregando && "animate-spin")}
            />
            Atualizar lista
          </Button>
        </header>
            ...
            <>
              ...
              <div className="flex flex-1 flex-col gap-3 overflow-y-auto bg-[#0b1220]/50 p-4">
                {carregandoChat ? (
                  ...
                  <>
                    {mensagens.map((m) => (
                      <BolhaMensagem key={m.id} msg={m} origem={ORIGEM} />
                    ))}
                    <div ref={fimRef} />
                  </>
                )}
