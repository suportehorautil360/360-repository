...
import { type AuthMessageTone, tratarUsuarioApiPosto } from '../portal/postoLoginFlow'
    ...
    >
      <div className="auth-card">
        ...
        <p className="quick-access">
          Contas demo (cada uma vê só sua prefeitura):{' '}
          <strong>admin</strong> / <strong>admin123</strong> (Três Lagoas-MS) ·{' '}
